...
export default function Home() {
  return (
    <section className="flex flex-col lg:flex-row">
      ...
      <IntroSection number={"01"} text={"ScholarlyLlama -  Our friend right here transforms your textbooks into dynamic chatbots, offering a unique and engaging way to explore and understand your course materials."}/>
